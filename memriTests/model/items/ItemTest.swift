...
class ItemTest: XCTestCase {
	...
	func testDeserializeItem() throws {
		...
		XCTAssertEqual(item.get("dateCreated", type: Date.self)!.timeIntervalSince1970, 1_586_517_071)
	...
	func testMerge() throws {
		...
		XCTAssertEqual(item1.get("dateCreated", type: Date.self)!.timeIntervalSince1970, 1_586_517_071)
