...
class Country: Item {
    ...
    @objc dynamic var flag: File? // or Image ??
...
class SchemaPerson: Item {
    ...
    @objc dynamic var profilePicture: File?
...
public class SchemaSessions: Item {
    ...
    public required convenience init(from decoder: Decoder) throws {
        ...
        jsonErrorHandling(decoder) {
            currentSessionIndex = try decoder
                .decodeIfPresent("currentSessionIndex") ?? currentSessionIndex
