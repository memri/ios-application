...
//    }
    ...
    static func authenticateOwnerByPasscode(_ callback: @escaping (Error?) -> Void) {
            ...
            let status: OSStatus = SecItemCopyMatching(query,
                                                       &typeRef) // This will prompt the passcode.
...
//                    kSecAttrApplicationTag as String: appTag,
    ...
    private static var lastRootPublicKey: Data? /* Data(hexString: "04F9A873A771CE81E3A4941236131B95DCF4C42761251892D207AF58EF0C821D29E8AA9DD5200265941E69290687C46AE1E89BFEB14C32749AB37A188CF9B6C5") */
    ...
    static func getPublicRootKeySync() throws -> Data {
        ...
        if
            let privateKey = (item as? [SecKey])?.last,
