...
extension NSAttributedString {
    ...
    func withFontSize(_ size: CGFloat) -> NSAttributedString {
        ...
        enumerateAttribute(
            ...
            guard let descriptor = systemFontDescriptor.withSymbolicTraits(traits)
            else { return
            } // We're intentionally overriding with system font here. There is a NSAttributedString bug that means TimesNewRoman will be used when loading HTML (instead of system)
