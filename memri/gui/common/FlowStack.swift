...
class AlignedFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect)
        ...
        { layoutAttribute in
            ...
            layoutAttributesForItem(at: layoutAttribute.indexPath)
                .map { layoutAttribute.frame = $0.frame }
        }
    ...
    private var contentWidth: CGFloat? {
        ...
        return collectionViewWidth - insets.left - insets.right - sectionInset.left - sectionInset
            .right
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath)
        ...
        guard
            ...
            layoutAttributesForItem(at: IndexPath(item: indexPath.item - 1,
                                                  section: indexPath.section))
        else {
            attributes.frame.origin
                .x = leftEdge // first item of the section should always be left aligned
            return attributes
        }
