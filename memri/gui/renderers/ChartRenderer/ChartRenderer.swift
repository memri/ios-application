...
class ChartRendererController: RendererController, ObservableObject {
    static let rendererType = RendererType(
        name: "chart",
        icon: "chart.bar",
        makeController: ChartRendererController.init,
        makeConfig: ChartRendererController.makeConfig
    )
...
struct ChartRendererView_Previews: PreviewProvider {
    static var previews: some View {
        ChartRendererView(controller: ChartRendererController(context: try! RootContext(name: "")
                .mockBoot(), config: nil))
    }
}
