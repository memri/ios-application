...
class ListConfig: RenderConfig {
    ...
    init(
        ...
        items _: [ActionDescription]? = nil,
        options1 _: [ActionDescription]? = nil,
        options2 _: [ActionDescription]? = nil,
        cascadeOrder: [String]? = nil,
        slideLeftActions: [ActionDescription]? = nil,
        slideRightActions: [ActionDescription]? = nil,
        type: String? = nil,
        browse: String? = nil,
        sortProperty: String? = nil,
        sortAscending: Int? = nil,
        itemRenderer: String? = nil,
        longPress: ActionDescription? = nil,
        press: ActionDescription? = nil
    ) {
        super.init()
...
struct ListRenderer: Renderer {
    ...
    var deleteAction = ActionDescription(
        icon: "",
        title: "",
        actionName: .delete,
        actionArgs: [],
                ...
                List {
                    ForEach(main.computedView.resultSet.items) { dataItem in
                        VStack {
                            ...
                            self.onTap(
                                actionDescription: (self.renderConfig as! ListConfig).press!,
                                dataItem: dataItem
                            )
                        }
...
struct ListRenderer_Previews: PreviewProvider {
    static var previews: some View {
        ListRenderer(isEditMode: .constant(.inactive))
