...
public class MemriTextEditor_UIKit: UITextView {
	...
	override public func layoutSubviews() {
		if let header = header {
			header.frame = CGRect(x: preferredContentInset.left + 5, y: 5 + toolbarInset, width: bounds.width - preferredContentInset.left - preferredContentInset.right - 10, height: headerSize)
		}
